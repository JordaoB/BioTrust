...
from backend.routes import users, merchants, transactions, liveness, liveness_stream, auth, cards, observability, location, face_id
...
app.include_router(face_id.router, prefix="/api/face-id", tags=["Face Identity"])
